namespace Delivery.Data.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ApplicattionUserId = c.Int(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.PostManagers", "ApplicationUser_Id", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.PostManagers", new[] { "ApplicationUser_Id" });
